...
class BaseNewscatcherApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._latestheadlines: typing.Optional[LatestheadlinesClient] = None
        self._breaking_news: typing.Optional[BreakingNewsClient] = None
        self._authors: typing.Optional[AuthorsClient] = None
        self._search_link: typing.Optional[SearchLinkClient] = None
        self._searchsimilar: typing.Optional[SearchsimilarClient] = None
    ...
    @property
    def latestheadlines(self):
        if self._latestheadlines is None:
            from .latestheadlines.client import LatestheadlinesClient  # noqa: E402

            self._latestheadlines = LatestheadlinesClient(client_wrapper=self._client_wrapper)
        return self._latestheadlines
    ...
    def search_link(self):
        if self._search_link is None:
            from .search_link.client import SearchLinkClient  # noqa: E402

            self._search_link = SearchLinkClient(client_wrapper=self._client_wrapper)
        return self._search_link

    @property
    def searchsimilar(self):
        if self._searchsimilar is None:
            from .searchsimilar.client import SearchsimilarClient  # noqa: E402

            self._searchsimilar = SearchsimilarClient(client_wrapper=self._client_wrapper)
        return self._searchsimilar
...
class AsyncBaseNewscatcherApi:
    ...
    def __init__(
        ...
        *,
        ...
        self._latestheadlines: typing.Optional[AsyncLatestheadlinesClient] = None
        self._breaking_news: typing.Optional[AsyncBreakingNewsClient] = None
        self._authors: typing.Optional[AsyncAuthorsClient] = None
        self._search_link: typing.Optional[AsyncSearchLinkClient] = None
        self._searchsimilar: typing.Optional[AsyncSearchsimilarClient] = None
    ...
    def latestheadlines(self):
        if self._latestheadlines is None:
            from .latestheadlines.client import AsyncLatestheadlinesClient  # noqa: E402

            self._latestheadlines = AsyncLatestheadlinesClient(client_wrapper=self._client_wrapper)
        return self._latestheadlines
    ...
    def search_link(self):
        if self._search_link is None:
            from .search_link.client import AsyncSearchLinkClient  # noqa: E402

            self._search_link = AsyncSearchLinkClient(client_wrapper=self._client_wrapper)
        return self._search_link

    @property
    def searchsimilar(self):
        if self._searchsimilar is None:
            from .searchsimilar.client import AsyncSearchsimilarClient  # noqa: E402

            self._searchsimilar = AsyncSearchsimilarClient(client_wrapper=self._client_wrapper)
        return self._searchsimilar
