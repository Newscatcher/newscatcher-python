...
_dynamic_imports: typing.Dict[str, str] = {
    "AggregationGetRequestPublishedDatePrecision": ".aggregation_get_request_published_date_precision",
    "AggregationGetRequestSortBy": ".aggregation_get_request_sort_by",
    "AggregationGetResponse": ".aggregation_get_response",
    "AggregationPostResponse": ".aggregation_post_response",
}
